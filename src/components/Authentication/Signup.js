...
const Signup = ({ handleClose }) => {
  ...
  return (
    <Box p={3} style={{display: 'flex', flexDirection: 'column'}}>
        ...
        <TextField variant="outlined" type="password" label="Confirm Password" value={confirmPassword} onChange={(e)=> setConfirmPassword(e.target.value)} fullWidth style={{marginBottom: 15}}></TextField>
